from CLASS_EXERCISES.Buoi_4.salesmanagement.libs.connector import MySQLConnector
from CLASS_EXERCISES.Buoi_4.salesmanagement.models.nhanvien import NhanVien
