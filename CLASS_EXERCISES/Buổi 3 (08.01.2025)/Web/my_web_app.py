...
# Function to find and sort orders
...
def main():
    if request.method == "POST":
        ...
        sort_type = request.form["sort_type"] == "asc"  # Ascending if 'asc', descending if 'desc'
        ...
        return render_template(
            "orders_sort.html",
            tables=[result.to_html(classes='data', index=False)],
